/**
 * Vendita Magnetoterapia Magnum 2500
 *
 * /prodotto/magnetoterapia-cemp-magnum-2500-2/
 * WooCommerce product 14176, 499,00 € — the sale twin of the hire Magnum 2500.
 */

import { generalTerms } from '../shared/terms.ts';
import { magnetotherapySale } from './category.ts';

export const magnum2500Sale = magnetotherapySale.fixed({
  code: 'magnum-2500-sale',
  status: 'active',
  ...
  translations: {
    it: {
      ...
      description: [
        ...
        '<h4>Caratteristiche principali del dispositivo:</h4>',
        ...
        '<p>L&#8217;acquisto del dispositivo per magnetoterapia <strong>MAGNUM 2500</strong> è la scelta ideale per chi cerca un <strong>trattamento efficace contro dolori articolari, patologie ossee e infiammatorie, direttamente a casa propria</strong>.<br />Contattaci oggi stesso al +<strong>39 392 65 09 237</strong> e acquista la tua magnetoterapia, consegna rapida!</p>',
        '<p><strong>Perché scegliere il servizio Mia Medical Italia</strong></p>',
        ...
        '<p>Con Mia Medical Italia, la cura non è mai stata così semplice e sicura. Prenota il tuo dispositivo ora e inizia la tua terapia in sole 24/48 ore! Che aspetti, <strong><a href="https://wa.me/393926509237">contattaci</a></strong> ora al +<strong>39 392 65 09 237.</strong> Chiamaci per acquistare oggi stesso il tuo dispositivo per la magneto terapia domiciliare. </p>',
      ].join(''),
    },
    en: {
      ...
      description: [
        ...
        '<p><strong>Why choose the Mia Medical Italia service</strong></p>',
        ...
        '<p>With Mia Medical Italia, treatment has never been easier and safer. Book your device now and start your treatment in just 24/48 hours! What are you waiting for, <strong><a href="https://wa.me/393926509237">contact us</a></strong> now at +<strong>39 392 65 09 237.</strong> Call us to purchase your home magneto therapy device today. </p>',
      ].join(''),
    },
  },
