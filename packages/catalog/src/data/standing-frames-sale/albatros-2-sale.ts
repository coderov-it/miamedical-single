...
export const albatros2Sale = standingFramesSale.fixed({
  ...
  translations: {
    it: {
      ...
      shortDescription:
        'Verticalizzatore stand-up elettrico Mette in posizione eretta senza sforzo da parte del paziente! Guarda il video per il funzionamento. Compatto, pieghevole e facile da usare. Batteria fino a 40 sollevamenti con una sola carica. Disponibilità immediata. Consegna Gratuita in caso di Acquisto',
      metaTitle: 'Verticalizzatore attivo Albatros 2 in vendita',
      metaDescription:
        'Vendita Verticalizzatore attivo Albatros 2: assistenza sicura e pratica. Compatto, pieghevole e facile da usare. Disponibilità immediata.',
      description: [
    ...
    en: {
      ...
      slug: 'verticalizzatore-attivo-albatros-2-in-vendita',
      shortDescription:
        'Electric stand-up standing hoist. Brings someone upright with no effort on their part. Watch the video to see it work. Compact, folding and easy to use. The battery is good for up to 40 lifts on one charge. Available immediately.',
      metaTitle: 'Albatros 2 active standing hoist for sale',
      metaDescription:
        'Albatros 2 active standing hoist for sale: safe, practical assistance. Compact, folding and easy to use. Available immediately.',
      description: [
