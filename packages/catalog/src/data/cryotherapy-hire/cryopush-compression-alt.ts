...
export const cryopushCompressionAlt = cryotherapyHire.rental({
  ...
  pricingMode: 'rental',
  rentalUnit: 'day',
  packages: [days(10, 160), days(20, 280), days(30, 360)],
  ...
  translations: {
    it: {
      ...
      metaDescription:
        'Noleggio crioterapia compressiva o Cryopush con compressione . Trasporto gratuito. Nessun Deposito. disponibilità immediata. Prenota online ora !',
      description: [
    ...
    en: {
      ...
      metaDescription:
        'Compression cryotherapy hire with the Cryopush. Free transport, no deposit, available immediately.',
      description: [
  ...
  media: {
    thumbnail: {
      file: 'cryopush-compression-alt-1.png',
    ...
    gallery: [
      ...
      {
        file: 'cryopush-compression-alt-5.png',
        alt: { it: 'terapia del freddo con compressione' },
      },
    ],
  },
