/**
 * Vendita Ultrasuono GLOBUS Medisound 3000
 *
 * /prodotto/acquista-ultrasuono-globus-medisound-3000/
 * WooCommerce product 14197, 980,00 € — the sale twin of the hire Medisound 3000.
...
export const globusMedisound3000Sale = ultrasoundSale.fixed({
  code: 'globus-medisound-3000-sale',
  status: 'active',
  brand: 'Globus',
  ...
  translations: {
    it: {
      ...
      description: [
        ...
        '<h3>Noleggio Ultrasuonoterapia GLOBUS Medisound 3000: caratteristiche del dispositivo</h3>',
        ...
        '<ul><li>Patologie croniche</li><li>Rigidità articolare</li><li>Contratture profonde<br />Genera calore endogeno, rilassa i tessuti e favorisce la vascolarizzazione sanguigna.</li></ul>',
    ...
    en: {
      ...
      description: [
        ...
        '<h3>GLOBUS Medisound 3000 ultrasound therapy rental: device features</h3>',
        ...
        '<ul><li>Chronic pathologies</li><li>Joint stiffness</li><li>Deep contractures<br />It generates endogenous heat, relaxes the tissues and promotes blood vascularisation.</li></ul>',
