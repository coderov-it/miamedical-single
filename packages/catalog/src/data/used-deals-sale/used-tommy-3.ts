...
export const usedTommy3 = usedDealsSale.fixed({
  ...
  translations: {
    ...
    en: {
      ...
      slug: 'vendita-scooter-usato-tommy-3',
      shortDescription:
        'Electric scooter Tommy Compact and lightweight design. Removable 12 Ah battery. Adjustable handlebar and column. Maximum speed of 8km/h. Tackles slopes of up to 10°',
