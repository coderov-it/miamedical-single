/**
 * Vendita carrozzina usata modello "Fantastica" 2
 *
 * /prodotto/vendita-carrozzina-usata-modello-fantastica-2/
 * WooCommerce product 14371, 539,00 €. States 18 kg without the battery.
 */

import { generalTerms } from '../shared/terms.ts';
import { usedDealsSale } from './category.ts';

export const usedFantastica2 = usedDealsSale.fixed({
  code: 'used-fantastica-2',
  status: 'active',
  ...
  translations: {
    it: {
      title: 'Vendita carrozzina usata modello “Fantastica” 2',
      slug: 'vendita-carrozzina-usata-modello-fantastica-2',
      shortDescription: 'Carrozzina elettrica fantastica Compatta e pieghevole per uso interno ed esterno. Solo 18 kg senza batteria, facile da trasportare. Maneggevole, con chiusura a libretto e joystick ambidestro. La batteria è estraibile per una ricarica pratica e veloce.',
      metaTitle: 'Vendita carrozzina usata modello "Fantastica" 2 - Mia Medical Italia',
      ...
      description: [
        ...
        '<p>Grazie al design <strong>ultra-compatto e leggero</strong> (solo 18 kg senza batteria), si muove agevolmente anche in spazi ristretti, offrendo un’autonomia che si adatta alle esigenze reali di chi la utilizza.</p>',
    ...
    en: {
      title: 'Used "Fantastica" wheelchair 2, for sale',
      slug: 'vendita-carrozzina-usata-modello-fantastica-2',
      shortDescription: 'Fantastic electric wheelchair Compact and foldable for indoor and outdoor use. Only 18 kg without battery, easy to transport. Handy, with booklet closure and ambidextrous joystick. The battery is removable for quick and convenient recharging.',
      metaTitle: 'Used "Fantastica" wheelchair 2 for sale - Mia Medical Italia',
      ...
      description: [
        ...
        '<p>Thanks to the design <strong>ultra-compact and lightweight</strong> (just 18 kg without battery), it moves easily even in tight spaces, offering a range that adapts to the actual needs of the user.</p>',
  ...
  media: {
    thumbnail: 'used-fantastica-2-1.jpg',
    gallery: [
      'used-fantastica-2-2.jpg',
      'used-fantastica-2-3.jpg',
      'used-fantastica-2-4.jpg',
      'used-fantastica-2-5.jpg',
      'used-fantastica-2-6.png',
    ],
  },
  terms: [generalTerms],
});
