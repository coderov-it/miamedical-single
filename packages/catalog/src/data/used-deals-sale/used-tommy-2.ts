/**
 * Vendita Scooter Usato Tommy 2
 *
 * /prodotto/vendita-scooter-usato-tommy-2/
 * WooCommerce product 14395, 390,00 €. Out of stock. Same specification as
 * Tommy 1, and this one has its basket.
 */

import { generalTerms } from '../shared/terms.ts';
import { usedDealsSale } from './category.ts';

export const usedTommy2 = usedDealsSale.fixed({
  code: 'used-tommy-2',
  status: 'active',
  stock: 0,
  ...
  translations: {
    it: {
      title: 'Vendita Scooter Usato Tommy 2',
      slug: 'vendita-scooter-usato-tommy-2',
      shortDescription:
        'Scooter elettrico Tommy Design compatto e leggero. Batteria rimovibile da 12 Ah. Manubrio e piantone regolabili. Velocità massima di 8km/h. Affronta pendenze fino a 10°',
      metaTitle: 'Vendita Scooter Usato Tommy 2',
      metaDescription:
        'Vendita Scooter Elettrico per la Mobilità Tommy usato, prezzi imbattibili con Mia Medical Italia. Chiama subito al +39 3926509237 .',
      description: [
    ...
    en: {
      title: 'Used Tommy scooter 2, for sale',
      slug: 'vendita-scooter-usato-tommy-2',
      shortDescription:
        'Tommy mobility scooter. Compact and light. Removable 12 Ah battery. Adjustable handlebar and steering column. Top speed 8 km/h. Handles gradients to 10°.',
      metaTitle: 'Used Tommy scooter 2 for sale',
      metaDescription:
        'Used Tommy mobility scooter for sale at unbeatable prices from Mia Medical Italia. Call +39 392 650 9237',
      description: [
