...
export const usedTommy2 = usedDealsSale.fixed({
  ...
  translations: {
    ...
    en: {
      ...
      slug: 'vendita-scooter-usato-tommy-2',
      shortDescription: 'Tommy mobility scooter. Compact and light. Removable 12 Ah battery. Adjustable handlebar and steering column. Top speed 8 km/h. Handles gradients to 10°.',
