...
export const usedFantastica3 = usedDealsSale.fixed({
  ...
  translations: {
    it: {
      ...
      shortDescription:
        'Carrozzina elettrica fantastica Compatta e pieghevole per uso interno ed esterno. Solo 16 kg senza batteria, facile da trasportare. Maneggevole, con chiusura a libretto e joystick ambidestro. ⚠️ Attenzione: senza cintura La batteria è estraibile per una ricarica pratica e veloce.',
    ...
    en: {
      ...
      slug: 'vendita-carrozzina-usata-modello-fantastica-2-2',
      shortDescription:
        'Fantastic electric wheelchair Compact and foldable for indoor and outdoor use. Only 16 kg without battery, easy to transport. Handy, with booklet closure and ambidextrous joystick. ⚠️ Warning: without belt The battery is removable for quick and convenient recharging.',
